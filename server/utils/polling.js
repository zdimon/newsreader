...
(function() {
  var debug, download_image, fs, get_new_issues_json, get_top_from_remote, http, issues_polling, makeresponse, path, polling, polling_catalog, poolling, process_issues, request, top_polling, utils, win;
