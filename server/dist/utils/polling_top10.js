...
(function() {
  var crop, done_path, download_image, easyimg, fs, getTop10FromFS, get_top10_from_server, get_top10_portal_from_server, http, log, makeresponse, makeresponse_portal, out, path, request, requestSync, utils;
  ...
  makeresponse_portal = function(options, onResult) {
    var dest;
  ...
  get_top10_portal_from_server = function(end) {
    var options;
    ...
    makeresponse_portal(options, function(code, res) {
      return console.log("Request is compleated with code " + code);
    });
    return end();
  };
